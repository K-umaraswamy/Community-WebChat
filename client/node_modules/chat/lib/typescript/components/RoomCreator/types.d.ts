...
import { NewMessageModel, SendFromFeedRecipients, SendFromFeedRecipientArray } from '../../classes/Message/types';
import { RoomMembers } from '../../classes/Room/types';
import { TextStyle, StyleProp, ImageStyle, ViewStyle, TextInputProps } from 'react-native';
...
export declare type RoomCreatorFunctions = {
...
export declare type Buttons = Button[];
export {};
